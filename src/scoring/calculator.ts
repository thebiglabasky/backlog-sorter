...
export function calculateIssueScore(
  ...
  if (issue.priority === 1) nativePriorityScore = 100; // Urgent
  else if (issue.priority === 2) nativePriorityScore = 70; // High
  else if (issue.priority === 3) nativePriorityScore = 40; // Medium
  else if (issue.priority === 4) nativePriorityScore = 20; // Low
